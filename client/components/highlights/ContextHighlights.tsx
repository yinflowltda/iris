...
export function ContextHighlights({ agent }: { agent: TldrawAgent }) {
	...
	const selectedAreas: AreaHighlightProps[] = useValue('selectedAreas', () => {
	...
	const activeAreas: AreaHighlightProps[] = useValue('activeAreas', () => {
	...
	const selectedShapes: AreaHighlightProps[] = useValue('selectedShapes', () => {
	...
	const activeShapes: AreaHighlightProps[] = useValue('activeShapes', () => {
	...
	const selectedShapesAreas: AreaHighlightProps[] = useValue('selectedShapesAreas', () => {
	...
	const activeShapeAreas: AreaHighlightProps[] = useValue('activeShapeAreas', () => {
	...
	const selectedPoints: PointHighlightProps[] = useValue('selectedPoints', () => {
	...
	const activePoints: PointHighlightProps[] = useValue('activePoints', () => {
