...
import type { FloraWorkerRequest, FloraWorkerResponse } from './types'

const MODEL_ID = 'Xenova/all-MiniLM-L6-v2'

let extractor: FeatureExtractionPipeline | null = null

function post(msg: FloraWorkerResponse, transfer?: Transferable[]) {
...
self.onmessage = (e: MessageEvent<FloraWorkerRequest>) => {
	const msg = e.data
	switch (msg.type) {
		case 'init':
			init()
